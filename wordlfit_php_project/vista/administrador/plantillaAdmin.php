                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle enlace_principal" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="fa-regular fa-user icono"></i> Mi perfil
                            </a>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <li><a class="dropdown-item enlace_secundario" href="#"><i class="fa-solid fa-cube icono"></i> Información</a></li>
                                <li><a class="dropdown-item enlace_secundario" href="#"><i class="fa-solid fa-gear icono"></i>Editar</a></li>
                                <li><a class="dropdown-item enlace_secundario" href="#">
                                        <button class="btn btn-outline-danger boton_cerrar"><i class="fa-solid fa-arrow-right-from-bracket icono"></i>Cerrar
                                            sesión</button>
                                    </a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle enlace_principal" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item enlace_secundario" href="#"><i class="fa-solid fa-eye icono"></i> Ver Rutinas</a></li>
                                <li><a class="dropdown-item enlace_secundario" href="#"><i class="fa-regular fa-pen-to-square icono"></i> Agregar Rutinas</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item enlace_secundario" href="#"><i class="fa-solid fa-eye icono"></i> Ver Gimnasios</a></li>
                                <li><a class="dropdown-item enlace_secundario" href="#"><i class="fa-regular fa-pen-to-square icono"></i> Agregar Gimnasios</a></li>
