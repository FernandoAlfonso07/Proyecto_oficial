    ...
    <div class="row">
        <div class="col-md-6 text-center opciones-dos-dos">
            <a href="#">
                <div class="card text-bg-dark position-relative contenedor-opcion-dos">
                    <img src="IMG_index/imagen_gimnasioss.png" class="card-img" alt="...">
                    <div
                        ...
                        <h5 class="card-title position-absolute top-50 start-50 translate-middle titulo-opcion">VER
                            GIMNASIOS
                            <img src="IMG_index/icono_ver_gyms.png" class="img-fluid pt-4" alt="icono de ver"
                                width="30px">
                        </h5>
                    </div>
                </div>
        ...
        <div class="col-md-6 text-center opciones-dos-dos">
            ...
            <a href="crear_calendario.html">
                <div class="card text-bg-dark position-relative contenedor-opcion-dos">
                    <img src="IMG_index/imagen-calendario.png" class="card-img" alt="...">
                    <div
                        class="card-img-overlay position-absolute top-50 start-50 translate-middle texto-opcion-dos efecto-cristal">

                        <h5 class="card-title position-absolute top-50 start-50 translate-middle titulo-opcion">
                            CREAR CALENDARIO
                            <img src="IMG_index/icono_gregar_calendario.png" class="img-fluid pt-4"
                                alt="icono de agregar" width="30px">
                        </h5>
                    </div>
                </div>
            </a>
