...
$nameCarpetaBase = basename(__DIR__);
...
if ($type == null) {
    ...
    $messageBody = "<a href='http://localhost/" . $nameCarpetaBase . "/view/password/change_password.php?usuiden=" . $id . "&step=2'>Cambio de contraseña aqui</a>";
